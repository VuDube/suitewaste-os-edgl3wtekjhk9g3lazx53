...
const RecentActivityTable = ({ title, data, columns, isLoading, viewAllLink }: { title: string; data: any[]; columns: { header: string; accessor: (item: any) => React.ReactNode }[]; isLoading: boolean; viewAllLink?: string }) => (
    ...
    case 'admin':
      return (
        <div className="grid gap-4 md:gap-6 lg:gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card className="col-span-1 lg:col-span-2 bg-secondary/50">
